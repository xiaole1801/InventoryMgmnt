...
class SortButtonRenderer extends JButton implements TableCellRenderer {
  ...
  public SortButtonRenderer() {
    ...
    downButton
        .setIcon(new BevelArrowIcon1(BevelArrowIcon1.DOWN, false, false));
    downButton.setPressedIcon(new BevelArrowIcon1(BevelArrowIcon1.DOWN,
        false, true));

    upButton = new JButton();
    upButton.setMargin(new Insets(0, 0, 0, 0));
    upButton.setHorizontalTextPosition(LEFT);
    upButton.setIcon(new BevelArrowIcon1(BevelArrowIcon1.UP, false, false));
    upButton.setPressedIcon(new BevelArrowIcon1(BevelArrowIcon1.UP, false,
        true));
...
class BevelArrowIcon1 implements Icon {
  ...
  public BevelArrowIcon1(int direction, boolean isRaisedView,
  ...
  public BevelArrowIcon1(Color edge1, Color edge2, Color fill, int size,
      int direction) {
