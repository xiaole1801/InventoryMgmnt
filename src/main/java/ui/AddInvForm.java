...
public class AddInvForm extends javax.swing.JFrame {
  ...
  public AddInvForm() {
    ...
    // *********************************************************************
    createTimePicker.setDate(new Date());
...
//      osles[i + 1] = osleList.get(i).getOSleID();
    ...
    creatuserlist = userlist;
    User currentuser = (User) HibernateUtil.findById(User.class, init.main.client.getUserID());
    for (int i = 0; i < userlist.size(); i++) {
      if (currentuser.getUserID().equals(userlist.get(i).getUserID())) {
        creatuserlist.remove(i);
        creatuserlist.add(0, currentuser);
      }
    }
    String[] creatusers = new String[creatuserlist.size()];
    for (int i = 0; i < creatuserlist.size(); i++)
      creatusers[i] = creatuserlist.get(i).getName();
...
//    managerComboBox.setModel(new DefaultComboBoxModel(users));
    ...
    createEngComboBox.setModel(new DefaultComboBoxModel(creatusers));
...
//    });
    ...
    jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        jPanel1Layout.createSequentialGroup().addGap(70, 70, 70).addComponent(addBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        jPanel1Layout.createSequentialGroup().addContainerGap(11, Short.MAX_VALUE)
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(addBtn).addComponent(printBtn).addComponent(cancelBtn)).addContainerGap()));
    ...
    jLabel4.setText("Client Project SN");
                ...
                jPanel3Layout
                    ...
                    .addGroup(
                        jPanel3Layout
                            .createSequentialGroup()
                            .addGroup(
                                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel1).addComponent(jLabel5).addComponent(jLabel8).addComponent(jLabel9)
                                    .addComponent(jLabel11).addComponent(jLabel13).addComponent(jLabel16).addComponent(jLabel21).addComponent(jLabel18).addComponent(jLabel19).addComponent(jLabel4))
                            .addGap(7, 7, 7)
                            .addGroup(
                                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(clientProNoText)
                                    .addComponent(managerComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(invIDText, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(radarText, javax.swing.GroupLayout.Alignment.LEADING).addComponent(configNoText, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(createTimePicker, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
                                    .addComponent(isleIDComboBox, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    ...
                                    .addComponent(checkinEngComboBox, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addGroup(
                                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel6).addComponent(jLabel7)
                                    .addComponent(jLabel10).addComponent(jLabel12).addComponent(jLabel14).addComponent(jLabel15).addComponent(jLabel22).addComponent(jLabel17).addComponent(jLabel20))
                            .addGap(39, 39, 39)
                            .addGroup(
                                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(checkoutTimePicker, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE)
                                    .addComponent(checkinTimePicker, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(projectNoText)
                                    .addComponent(vendorText).addComponent(securityStatusComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    ...
                                    .addComponent(checkoutComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(sysSNText)
                                    .addComponent(osleIDComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))).addGap(11, 11, 11)));
    jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        jPanel3Layout
            ...
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel4)
                    .addComponent(clientProNoText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel6)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel5)
                    .addComponent(createTimePicker, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel7)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel8)
                    .addComponent(storageIDComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel10)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel9)
                    .addComponent(isleIDComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel12)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel11)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel13)
                    .addComponent(configNoText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel15)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel16)
                    .addComponent(proStatusComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel22)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel21)
                    .addComponent(storageStatusComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel17)
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel18)
                    .addComponent(managerComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel20)
    ...
    jPanel2Layout
        .setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
            jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap()));
...
//    byte[] imageByte = Label.creatLabel(invid.substring(0, 12), invid, "Inventory", projectNoText.getText());
    ...
    int response = JOptionPane.showOptionDialog(AddInvForm.this, "Are you sure you want to print the tag?", "Warning", JOptionPane.YES_OPTION, JOptionPane.PLAIN_MESSAGE, icon, options, options[0]);
    if (response == 1) {
      return;
    }if (response == 0) {
  ...
  private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    inv.setInvID(invIDText.getText());
    ...
    inv.setCreatEngID(userlist.get(createEngComboBox.getSelectedIndex()).getUserID());

    inv.setCreatTime(createTimePicker.getDate());
    ...
    if (storageStatusComboBox.getSelectedItem().toString().equals("checked in")) {
      if (checkinEngComboBox.getSelectedIndex() > 0)
        ...
        JOptionPane.showMessageDialog(AddInvForm.this, "Please select the \"Checkin Engineer\" before adding this item", "error", JOptionPane.INFORMATION_MESSAGE);
        return;
      }
      inv.setCheckInTime(checkinTimePicker.getDate());
      if ((storageList.size() == 0) || (storageIDComboBox.getSelectedIndex() <= 0)) {
        JOptionPane.showMessageDialog(AddInvForm.this, "Please select the \"Locker\" before adding this item", "error", JOptionPane.INFORMATION_MESSAGE);
        return;
      } else
        inv.setStorageID(storageList.get(storageIDComboBox.getSelectedIndex() - 1).getStorageID());
    } else {
      if (checkoutComboBox.getSelectedIndex() > 0)
        inv.setCheckOutEngID(userlist.get(checkoutComboBox.getSelectedIndex() - 1).getUserID());
      else {
        JOptionPane.showMessageDialog(AddInvForm.this, "Please select the \"Checkout Engineer\" before adding this item", "error", JOptionPane.INFORMATION_MESSAGE);
        return;
      }
    ...
    // inv.setCreatEngID(main.client.getUserID());
    ...
    JOptionPane.showMessageDialog(AddInvForm.this, "Item:" + invIDText.getText()+" is added successfully!", "OK", JOptionPane.INFORMATION_MESSAGE);
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new AddInvForm().setVisible(true);
      }
    });
  }
...
//  private javax.swing.JComboBox managerComboBox;
  ...
  private List<User> creatuserlist;
