...
public class CheckInForm extends javax.swing.JFrame {
  ...
  private static final long serialVersionUID = -4835267880428039536L;
    ...
    private void initComponents() {
      ...
      lockerTextField = new javax.swing.JTextField();
      ...
      lockerTextField.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
      lockerTextField.setForeground(new java.awt.Color(0, 51, 153));
      lockerTextField.addKeyListener(new java.awt.event.KeyAdapter() {
          public void keyTyped(java.awt.event.KeyEvent evt) {
              lockerTextFieldKeyTyped(evt);
          }
          public void keyPressed(java.awt.event.KeyEvent evt) {
            lockerTextFieldKeyPressed(evt);
          }
      });
    ...
    private void okBtnActionPerformed(java.awt.event.ActionEvent evt) {  
      ...
      if (lockerTextField.getText().equals("")){
        JOptionPane.showOptionDialog ( frmOpt, "Please input or scan the locker ID","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
          return;
      }
      options = new Object[]{"Yes","No"};
      int response=JOptionPane.showOptionDialog ( frmOpt, "Are you sure you want to check in all the items?","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
      if (response == 1){
        return;
      }
      Date date = new Date();
      ...
      for (int i = 0; i < SannerList.getModel().getSize(); i++) {
        ...
        if (inv != null){
          ...
          Storage sto = (Storage) HibernateUtil.findById(Storage.class, lockerTextField.getText());
          if (sto == null){
        	  options = new Object[]{"Close"};
              JOptionPane.showOptionDialog ( frmOpt, showStr+"The Locker"
              		+ " doesn't exist!","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
              lockerTextField.setText("");	
              return;
          }
          inv.setStorageID(lockerTextField.getText());
      ...
      if (invList.size()>0){
        ...
        options = new Object[]{"Close"};
        JOptionPane.showOptionDialog ( frmOpt, showStr+"These items don't exist!","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
        	return;
      }else{
      options = new Object[]{"Close"};
      JOptionPane.showOptionDialog ( frmOpt, showStr+"These items have checked into the locker","Info",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
      }
      lockerTextField.setText("");
      lm.clear();
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {                                       
      ...
      frmOpt.setAlwaysOnTop(true);
      int response=JOptionPane.showOptionDialog ( frmOpt, "Are you sure you want to delete all seleted items?","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE, null, options, options[0] ) ;
      if (response == 1){
        return;
      }
      if(lm.getSize() == 0)
...
//            scanTextField.setText("");
  ...
  private void scanTextFieldKeyPressed(java.awt.event.KeyEvent evt) {
    ...
    if (  evt.getKeyCode() == KeyEvent.VK_SPACE) {
      lockerTextField.requestFocus();
    }
  }

  private void lockerTextFieldKeyPressed(java.awt.event.KeyEvent evt) {
    // TODO add your handling code here:
    if ( evt.getKeyCode() == KeyEvent.VK_SPACE) {
    ...
    private void lockerTextFieldKeyTyped(KeyEvent evt) {
    ...
    private javax.swing.JTextField lockerTextField;
