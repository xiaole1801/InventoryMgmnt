...
public class AddUserForm extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    while (true) {
      ...
      User user = (User) HibernateUtil.findById(User.class, newid);
      if (user == null) {
        userIDText.setText(newid);
        userIDText.setEnabled(false);
        break;
      }
    }

    roleComboBox.setModel(new DefaultComboBoxModel(new String[] { "Administrative Assistant (AA)", "Engineer (ENG)", "Inventory Custodian (IC)" }));
    ...
    jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        jPanel1Layout.createSequentialGroup().addComponent(addBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGap(12, 12, 12)
            .addComponent(printBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            .addComponent(cancelBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addContainerGap()));
    ...
    jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        jPanel3Layout
            ...
            .addGap(16, 16, 16)
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel4).addComponent(jLabel2).addComponent(jLabel1).addComponent(jLabel5))
            .addGap(18, 18, 18)
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(userIDText).addComponent(userNameText).addComponent(roleComboBox, 0, 197, Short.MAX_VALUE)
                    .addComponent(nameText)).addContainerGap()));
    jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
        jPanel3Layout
            ...
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2)
            ...
            .addGroup(
                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel4)
                    .addComponent(roleComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(14, 14, 14)));
  ...
  private void printBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_printBtnActionPerformed
    ...
    User user = (User) HibernateUtil.findById(User.class, userIDText.getText());
    if (user == null) {
      JOptionPane.showMessageDialog(AddUserForm.this, "please add user firstly", "error", JOptionPane.ERROR_MESSAGE);
      return;
    }
    ...
    int response = JOptionPane.showOptionDialog(AddUserForm.this, "Are you sure you want to print the tag?", "Warning", JOptionPane.YES_OPTION, JOptionPane.PLAIN_MESSAGE, icon, options, options[0]);
    if (response == 1) {
      return;
    }if (response == 0) {
  ...
  private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addBtnActionPerformed
    ...
    if (userNameText.getText().length() == 0) {
      JOptionPane.showMessageDialog(AddUserForm.this, "please input the \"User Name\" before adding this user", "error", JOptionPane.ERROR_MESSAGE);
      return;
    }

    String username = userNameText.getText();
    String sqlStr = "select * from inv.USER where USERNAME = '" + username + "'";
    List<User> quser = HibernateUtil.queryBySql(User.class, sqlStr);
    if (quser.size() != 0) {
      JOptionPane.showMessageDialog(AddUserForm.this, "The \"User Name\" has been used!", "error", JOptionPane.ERROR_MESSAGE);
      return;
    }
    ...
    JOptionPane.showMessageDialog(AddUserForm.this, "User " + userIDText.getText()+" is added successfully" + "\n" + "The default password is 1234", "OK", JOptionPane.INFORMATION_MESSAGE);
