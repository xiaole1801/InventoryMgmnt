  ...
  private static final long serialVersionUID = 1L;
    ...
    private void okBtnActionPerformed(java.awt.event.ActionEvent evt) {   
      ...
      if (lockerTextField.getText().equals("")){
        lockerTextField.setText(init.main.client.getUserID());
      }
      Date date = new Date();
      String showStr = "";
      for (int i = 0; i < SannerList.getModel().getSize(); i++) {
        ...
        if (inv != null){
          inv.setCheckOutEngID(init.main.client.getUserID());
          inv.setCheckOutTime(date);
          User user = (User) HibernateUtil.findById(User.class, lockerTextField.getText());
          if (user == null){
        	  options = new Object[]{"Close"};
              JOptionPane.showOptionDialog ( frmOpt, showStr+"The User"
              		+ " doesn't exist!","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
              lockerTextField.setText("");	
              return;
          }
          inv.setCheckOutEngID(lockerTextField.getText());
      ...
      if (invList.size()>0){
        ...
        options = new Object[]{"Close"};
        JOptionPane.showOptionDialog ( frmOpt, showStr+"These items"
        		+ " don't exist!","Warning",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
        	return;
      }
      options = new Object[]{"Close"};
      JOptionPane.showOptionDialog ( frmOpt, showStr+"These items"
    		  + " have checked out","Info",JOptionPane.YES_OPTION ,JOptionPane.PLAIN_MESSAGE,null, options, options[0] ) ;
      lockerTextField.setText("");
      lm.clear();
...
//        System.out.println(SannerList.getSelectedIndex());
      Object[] options = {"Yes","No"};
      JFrame frmOpt = null;
      if (frmOpt == null) {
        frmOpt = new JFrame();
